...
AI编程工具只是一个"壳"，真正写代码的是里面的大模型。选对模型，代码质量天差地别。

> 详细对比表见[附录D：工具对照表](appendix-d-tool-comparison.md)。

**新手推荐**：Gemini 3.1 Pro（免费额度大，上下文超长）或 GLM-5.1（中文理解最好，免费开源）。
...
[第3章：学会和AI说话 ->](03-prompt-engineering.md)